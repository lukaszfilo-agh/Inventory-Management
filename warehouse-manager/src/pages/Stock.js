  ...
  return (
    <ListView
      ...
      renderActions={(stock, navigate) => (
        <>
          <button className="btn btn-primary btn-sm me-2" onClick={() => navigate(`/items/${stock.item_id}`)}>
            View Item
          </button>
          <button className="btn btn-secondary btn-sm" onClick={() => navigate(`/warehouse/${stock.warehouse_id}`)}>
            View Warehouse
          </button>
        </>
      )}
